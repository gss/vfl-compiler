module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c60 = function(view, pred) {view = p.stringify(view); p.addSelector(view); return {view:view,preds:pred};},
        peg$c61 = "...",
        peg$c62 = { type: "literal", value: "...", description: "\"...\"" },
        peg$c63 = function(o, connection) {o.isSplat = true; o.connection = connection; return o;},
        ...
        peg$c97 = function(name) {return "[" + name.join("") + "]";},
        peg$c98 = function(view, prop) {return view.join("") + "[" + prop.join("") + "]";},
        peg$c99 = function() {return "";},
        peg$c100 = { type: "other", description: "VFL Connection" },
        peg$c101 = "-",
        ...
        peg$c107 = function(gap) {return {op:"<=",gap:gap};},
        peg$c108 = function() {return {op:"<=",gap:"__STANDARD__"};},
        peg$c109 = function() {return {op:"<="};},
        peg$c110 = "",
        peg$c111 = function() {return {op:"=="};},
        peg$c112 = { type: "other", description: "VFL Connection Gap" },
        peg$c113 = /^[a-zA-Z0-9_$]/,
        peg$c114 = { type: "class", value: "[a-zA-Z0-9_$]", description: "[a-zA-Z0-9_$]" },
        peg$c115 = function(gap) {return gap.join("");},
        peg$c116 = /^[^[]/,
        peg$c117 = { type: "class", value: "[^[]", description: "[^[]" },
        peg$c118 = /^[^\]]/,
        peg$c119 = { type: "class", value: "[^\\]]", description: "[^\\]]" },
        peg$c120 = function(gap, varr) {return gap.join("") + "[" + varr.join("") + "]";},
        peg$c121 = { type: "other", description: "Strength / Weight" },
        peg$c122 = "!",
