module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c56 = function(name, pred) {return {view:p.stringify(name),preds:pred};},
        peg$c57 = function(point) {return {view:"|", isPoint:true, pos:point};},
        peg$c58 = function() {return {view:"|"};},
        peg$c59 = function(view, pred) {view = p.stringify(view); p.addSelector(view); return {view:view,preds:pred};},
        peg$c60 = "...",
        peg$c61 = { type: "literal", value: "...", description: "\"...\"" },
        peg$c62 = function(o, connection) {o.isSplat = true; o.connection = connection; return o;},
        peg$c63 = { type: "other", description: "Point" },
        peg$c64 = "<",
        ...
        peg$c70 = function(position) {
            return p.stringify(position);
          },
        peg$c71 = { type: "other", description: "Predicate" },
        peg$c72 = function(preds) {return preds;},
        peg$c73 = { type: "other", description: "Predicate Expression" },
        peg$c74 = "==",
        ...
        peg$c86 = function(eq) {return eq;},
        peg$c87 = /^[+\-\/*]/,
        peg$c88 = { type: "class", value: "[+\\-\\/*]", description: "[+\\-\\/*]" },
        peg$c89 = function(op) {return op;},
        peg$c90 = function(name) {return ["view",name.join("")];},
        peg$c91 = function(n) {return n.join("");},
        peg$c92 = "[",
        peg$c93 = { type: "literal", value: "[", description: "\"[\"" },
        peg$c94 = "]",
        peg$c95 = { type: "literal", value: "]", description: "\"]\"" },
        peg$c96 = function(name) {return "[" + name.join("") + "]";},
        peg$c97 = function(view, prop) {return view.join("") + "[" + prop.join("") + "]";},
        peg$c98 = function() {return "";},
        peg$c99 = { type: "other", description: "VFL Connection" },
        peg$c100 = "-",
        peg$c101 = { type: "literal", value: "-", description: "\"-\"" },
        peg$c102 = function(gap) {return {op:"==",gap:gap};},
        peg$c103 = function() {return {op:"==",gap:"__STANDARD__"};},
        peg$c104 = "~",
        peg$c105 = { type: "literal", value: "~", description: "\"~\"" },
        peg$c106 = function(gap) {return {op:"<=",gap:gap};},
        peg$c107 = function() {return {op:"<=",gap:"__STANDARD__"};},
        peg$c108 = function() {return {op:"<="};},
        peg$c109 = "",
        peg$c110 = function() {return {op:"=="};},
        peg$c111 = { type: "other", description: "VFL Connection Gap" },
        peg$c112 = /^[a-zA-Z0-9_$]/,
        peg$c113 = { type: "class", value: "[a-zA-Z0-9_$]", description: "[a-zA-Z0-9_$]" },
        peg$c114 = function(gap) {return gap.join("");},
        peg$c115 = /^[^[]/,
        peg$c116 = { type: "class", value: "[^[]", description: "[^[]" },
        peg$c117 = /^[^\]]/,
        peg$c118 = { type: "class", value: "[^\\]]", description: "[^\\]]" },
        peg$c119 = function(gap, varr) {return gap.join("") + "[" + varr.join("") + "]";},
        peg$c120 = { type: "other", description: "Strength / Weight" },
        peg$c121 = "!",
        ...
        peg$c127 = function(s, w) {
            var val;
            val = "!" + p.join(s) + p.join(w);
            return val.trim();
          },
        peg$c128 = { type: "any", description: "any character" },
        peg$c129 = function() {
