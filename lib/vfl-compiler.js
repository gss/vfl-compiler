    ...
    parse: function(input, startRule) {
      ...
      function parse_VFLStatement() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, d, head, tail, o, s) {
              var connection, view2, result, ccss;
              result = head;
              for (var i = 0; i < tail.length; i++) {        
                ...
                ccss = parser.getLeftVar(head, d, o) + " " + 
      ...
      function parse_Predicate() {
        ...
        if (result0 !== null) {
          result1 = parse_Eq();
          if (result1 !== null) {
            result3 = parse_PredOp();
            if (result3 === null) {
              result3 = parse_PredView();
              if (result3 === null) {
        ...
        if (result0 !== null) {
          result0 = (function(offset) {return "pred"})(pos0);
        }
        if (result0 === null) {
          pos = pos0;
        }
      ...
      function parse_StrengthAndWeight() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, s, w) {if (w.join){w=w.join("");} return "!" + s.join("") + w;})(pos0, result0[1], result0[2]);
        }
        if (result0 === null) {
          pos = pos0;
        }
